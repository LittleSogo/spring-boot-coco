  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      <div class="title-container">
        <h3 class="title">spring-boot-coco</h3>
      </div>
      ...
      <div style="position:relative">
        <div class="tips">
          <span>spring-boot-coco</span>
        </div>
      </div>
    </el-form>

    <div class="copyright">
      Copyright © 2020 luomor.com 版权所有 <a href="http://www.beian.miit.gov.cn/publish/query/indexFirst.action">京ICP备16044936号-1</a>
    </div>
  </div>
</template>
