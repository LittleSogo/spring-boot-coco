...
import com.luomor.coco.db.dao.CocoAftersaleMapper;
...
@Service
public class CocoAftersaleService {
    @Resource
    private CocoAftersaleMapper aftersaleMapper;

    public CocoAftersale findById(Integer id) {
        return aftersaleMapper.selectByPrimaryKey(id);
    }

    public CocoAftersale findById(Integer userId, Integer id) {
        CocoAftersaleExample example = new CocoAftersaleExample();
        example.or().andIdEqualTo(id).andUserIdEqualTo(userId).andDeletedEqualTo(false);
        return aftersaleMapper.selectOneByExample(example);
    }

    public List<CocoAftersale> queryList(Integer userId, Short status, Integer page, Integer limit, String sort, String order) {
        CocoAftersaleExample example = new CocoAftersaleExample();
        CocoAftersaleExample.Criteria criteria = example.or();
        ...
        if (!StringUtils.isEmpty(sort) && !StringUtils.isEmpty(order)) {
            ...
            example.setOrderByClause(CocoAftersale.Column.addTime.desc());
        }
    ...
    public List<CocoAftersale> querySelective(Integer orderId, String aftersaleSn, Short status, Integer page, Integer limit, String sort, String order) {
        CocoAftersaleExample example = new CocoAftersaleExample();
        CocoAftersaleExample.Criteria criteria = example.or();
        if (orderId != null) {
    ...
    public void add(CocoAftersale aftersale) {
    ...
    public void deleteByIds(List<Integer> ids) {
        ...
        CocoAftersale aftersale = new CocoAftersale();
        aftersale.setUpdateTime(LocalDateTime.now());
    ...
    public void updateById(CocoAftersale aftersale) {
        aftersale.setUpdateTime(LocalDateTime.now());
        aftersaleMapper.updateByPrimaryKeySelective(aftersale);
    }

    public CocoAftersale findByOrderId(Integer userId, Integer orderId) {
        CocoAftersaleExample example = new CocoAftersaleExample();
        example.or().andOrderIdEqualTo(orderId).andUserIdEqualTo(userId).andDeletedEqualTo(false);
        return aftersaleMapper.selectOneByExample(example);
    }
