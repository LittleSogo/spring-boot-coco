...
import com.luomor.coco.db.dao.CocoGrouponMapper;
...
@Service
public class CocoGrouponService {
    @Resource
    private CocoGrouponMapper mapper;
     ...
     * @return
     */
    public List<CocoGroupon> queryMyGroupon(Integer userId) {
        CocoGrouponExample example = new CocoGrouponExample();
     ...
     * @return
     */
    public List<CocoGroupon> queryMyJoinGroupon(Integer userId) {
        CocoGrouponExample example = new CocoGrouponExample();
     ...
     * @return
     */
    public CocoGroupon queryByOrderId(Integer orderId) {
        CocoGrouponExample example = new CocoGrouponExample();
     ...
     * @return
     */
    public List<CocoGroupon> queryJoinRecord(Integer id) {
        CocoGrouponExample example = new CocoGrouponExample();
     ...
     * @return
     */
    public CocoGroupon queryById(Integer id) {
        CocoGrouponExample example = new CocoGrouponExample();
     ...
     * @return
     */
    public CocoGroupon queryById(Integer userId, Integer id) {
        CocoGrouponExample example = new CocoGrouponExample();
    ...
    public int updateById(CocoGroupon groupon) {
     ...
     * @return
     */
    public int createGroupon(CocoGroupon groupon) {
     ...
     * @return
     */
    public List<CocoGroupon> querySelective(String rulesId, Integer page, Integer size, String sort, String order) {
        CocoGrouponExample example = new CocoGrouponExample();
        CocoGrouponExample.Criteria criteria = example.createCriteria();
    ...
    public List<CocoGroupon> queryByRuleId(int grouponRuleId) {
        CocoGrouponExample example = new CocoGrouponExample();
