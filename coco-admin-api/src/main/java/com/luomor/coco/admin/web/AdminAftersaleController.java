...
import com.luomor.coco.admin.service.LogHelper;
...
import com.luomor.coco.db.util.AftersaleConstant;
...
import static com.luomor.coco.admin.util.AdminResponseCode.ORDER_REFUND_FAILED;
...
public class AdminAftersaleController {
    ...
    @Autowired
    private CocoGoodsProductService goodsProductService;
    @Autowired
    ...
    public Object list(Integer orderId, String aftersaleSn, Short status,
        ...
        List<CocoAftersale> aftersaleList = aftersaleService.querySelective(orderId, aftersaleSn, status, page, limit, sort, order);
    ...
    @PostMapping("/recept")
    public Object recept(@RequestBody CocoAftersale aftersale) {
        Integer id = aftersale.getId();
        CocoAftersale aftersaleOne = aftersaleService.findById(id);
    ...
    public Object batchRecept(@RequestBody String body) {
        ...
        for(Integer id : ids) {
            CocoAftersale aftersale = aftersaleService.findById(id);
            if(aftersale == null){
                continue;
            }
    ...
    @PostMapping("/reject")
    public Object reject(@RequestBody CocoAftersale aftersale) {
        Integer id = aftersale.getId();
        CocoAftersale aftersaleOne = aftersaleService.findById(id);
        if(aftersaleOne == null){
    ...
    @PostMapping("/refund")
    public Object refund(@RequestBody CocoAftersale aftersale) {
        Integer id = aftersale.getId();
        CocoAftersale aftersaleOne = aftersaleService.findById(id);
        if(aftersaleOne == null){
            return ResponseUtil.badArgumentValue();
        ...
        CocoOrder order = orderService.findById(orderId);
