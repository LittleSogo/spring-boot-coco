...
import com.luomor.coco.db.service.CocoAdminService;
import com.luomor.coco.db.service.CocoPermissionService;
import com.luomor.coco.db.service.CocoRoleService;
...
import static com.luomor.coco.admin.util.AdminResponseCode.ROLE_NAME_EXIST;
import static com.luomor.coco.admin.util.AdminResponseCode.ROLE_USER_EXIST;
...
public class AdminRoleController {
    ...
    @Autowired
    private CocoRoleService roleService;
    @Autowired
    private CocoPermissionService permissionService;
    @Autowired
    private CocoAdminService adminService;
    ...
    public Object list(String name,
        ...
        List<CocoRole> roleList = roleService.querySelective(name, page, limit, sort, order);
        return ResponseUtil.okList(roleList);
    }

    @GetMapping("/options")
    public Object options() {
        List<CocoRole> roleList = roleService.queryAll();
    ...
    public Object read(@NotNull Integer id) {
        CocoRole role = roleService.findById(id);
        return ResponseUtil.ok(role);
    }


    private Object validate(CocoRole role) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody CocoRole role) {
    ...
    @PostMapping("/update")
    public Object update(@RequestBody CocoRole role) {
        Object error = validate(role);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody CocoRole role) {
        ...
        List<CocoAdmin> adminList = adminService.all();
        for (CocoAdmin admin : adminList) {
    ...
    public Object updatePermissions(@RequestBody String body) {
        ...
        for (String permission : permissions) {
            CocoPermission cocoPermission = new CocoPermission();
            cocoPermission.setRoleId(roleId);
            cocoPermission.setPermission(permission);
            permissionService.add(cocoPermission);
        }
        return ResponseUtil.ok();
    }
