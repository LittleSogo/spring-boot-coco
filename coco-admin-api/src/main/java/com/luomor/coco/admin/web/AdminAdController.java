...
import com.luomor.coco.db.service.CocoAdService;
...
public class AdminAdController {
    ...
    public Object list(String name, String content,
        ...
        List<CocoAd> adList = adService.querySelective(name, content, page, limit, sort, order);
        return ResponseUtil.okList(adList);
    }

    private Object validate(CocoAd ad) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody CocoAd ad) {
    ...
    public Object read(@NotNull Integer id) {
        CocoAd ad = adService.findById(id);
        return ResponseUtil.ok(ad);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody CocoAd ad) {
        Object error = validate(ad);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody CocoAd ad) {
        Integer id = ad.getId();
        if (id == null) {
            return ResponseUtil.badArgument();
        }
