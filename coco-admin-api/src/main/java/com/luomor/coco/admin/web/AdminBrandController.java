...
import com.luomor.coco.db.service.CocoBrandService;
...
public class AdminBrandController {
    ...
    public Object list(String id, String name,
        ...
        List<CocoBrand> brandList = brandService.querySelective(id, name, page, limit, sort, order);
        return ResponseUtil.okList(brandList);
    }

    private Object validate(CocoBrand brand) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody CocoBrand brand) {
    ...
    public Object read(@NotNull Integer id) {
        CocoBrand brand = brandService.findById(id);
        return ResponseUtil.ok(brand);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody CocoBrand brand) {
        Object error = validate(brand);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody CocoBrand brand) {
