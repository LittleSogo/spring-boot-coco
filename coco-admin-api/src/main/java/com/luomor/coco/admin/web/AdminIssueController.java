...
public class AdminIssueController {
    ...
    public Object list(String question,
        ...
        List<CocoIssue> issueList = issueService.querySelective(question, page, limit, sort, order);
        return ResponseUtil.okList(issueList);
    }

    private Object validate(CocoIssue issue) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody CocoIssue issue) {
    ...
    public Object read(@NotNull Integer id) {
        CocoIssue issue = issueService.findById(id);
        return ResponseUtil.ok(issue);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody CocoIssue issue) {
        Object error = validate(issue);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody CocoIssue issue) {
