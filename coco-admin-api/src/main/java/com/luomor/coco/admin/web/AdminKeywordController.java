...
import com.luomor.coco.db.service.CocoKeywordService;
...
public class AdminKeywordController {
    ...
    @Autowired
    private CocoKeywordService keywordService;
    ...
    public Object list(String keyword, String url,
        ...
        List<CocoKeyword> keywordList = keywordService.querySelective(keyword, url, page, limit, sort, order);
        return ResponseUtil.okList(keywordList);
    }

    private Object validate(CocoKeyword keywords) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody CocoKeyword keyword) {
    ...
    public Object read(@NotNull Integer id) {
        CocoKeyword keyword = keywordService.findById(id);
        return ResponseUtil.ok(keyword);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody CocoKeyword keyword) {
        Object error = validate(keyword);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody CocoKeyword keyword) {
