...
import com.luomor.coco.wx.service.HomeCacheManager;
...
public class WxCatalogController {
    ...
    public Object getSecondCategory(@NotNull Integer id) {
        // 所有二级分类目录
        List<CocoCategory> currentSubCategory = categoryService.queryByPid(id);
    ...
    public Object index(Integer id) {
        ...
        // 当前一级分类目录
        CocoCategory currentCategory = null;
        if (id != null) {
        ...
        // 当前一级分类目录对应的二级分类目录
        List<CocoCategory> currentSubCategory = null;
    ...
    public Object queryAll() {
        ...
        //所有子分类列表
        Map<Integer, List<CocoCategory>> allList = new HashMap<>();
        List<CocoCategory> sub;
        ...
        // 当前一级分类目录
        CocoCategory currentCategory = l1CatList.get(0);
    ...
    public Object current(@NotNull Integer id) {
        // 当前分类
        CocoCategory currentCategory = categoryService.findById(id);
        if(currentCategory == null){
            return ResponseUtil.badArgumentValue();
        }
        List<CocoCategory> currentSubCategory = categoryService.queryByPid(currentCategory.getId());
