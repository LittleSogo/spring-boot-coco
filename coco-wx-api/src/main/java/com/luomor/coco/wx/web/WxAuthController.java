...
import com.luomor.coco.db.service.CouponAssignService;
...
import com.luomor.coco.wx.dto.WxLoginInfo;
import com.luomor.coco.wx.service.CaptchaCodeManager;
...
public class WxAuthController {
    ...
    public Object login(@RequestBody String body, HttpServletRequest request) {
        ...
        List<CocoUser> userList = userService.queryByUsername(username);
        CocoUser user = null;
        if (userList.size() > 1) {
    ...
    public Object loginByWeixin(@RequestBody WxLoginInfo wxLoginInfo, HttpServletRequest request) {
        ...
        CocoUser user = userService.queryByOid(openId);
        if (user == null) {
            user = new CocoUser();
    ...
    public Object register(@RequestBody String body, HttpServletRequest request) {
        ...
        if(!StringUtils.isEmpty(wxCode)) {
            ...
            if (userList.size() == 1) {
                CocoUser checkUser = userList.get(0);
    ...
    public Object reset(@RequestBody String body, HttpServletRequest request) {
        ...
        List<CocoUser> userList = userService.queryByMobile(mobile);
        CocoUser user = null;
        if (userList.size() > 1) {
            return ResponseUtil.serious();
        } else if (userList.size() == 0) {
