...
import com.luomor.coco.db.service.CocoCommentService;
...
import com.luomor.coco.wx.service.UserInfoService;
...
public class WxCommentController {
    ...
    private Object validate(CocoComment comment) {
     ...
     */
    @PostMapping("post")
    public Object post(@LoginUser Integer userId, @RequestBody CocoComment comment) {
        if (userId == null) {
    ...
    public Object list(@NotNull Byte type,
        ...
        List<CocoComment> commentList = commentService.query(type, valueId, showType, page, limit);

        List<Map<String, Object>> commentVoList = new ArrayList<>(commentList.size());
        for (CocoComment comment : commentList) {
