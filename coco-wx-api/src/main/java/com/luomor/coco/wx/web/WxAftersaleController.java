...
public class WxAftersaleController {
    ...
    public Object list(@LoginUser Integer userId,
        ...
        List<CocoAftersale> aftersaleList = aftersaleService.queryList(userId, status, page, limit, sort, order);

        List<Map<String, Object>> aftersaleVoList = new ArrayList<>(aftersaleList.size());
        for (CocoAftersale aftersale : aftersaleList) {
            List<CocoOrderGoods> orderGoodsList = orderGoodsService.queryByOid(aftersale.getOrderId());
    ...
    public Object detail(@LoginUser Integer userId, @NotNull Integer orderId) {
        ...
        CocoAftersale aftersale = aftersaleService.findByOrderId(userId, orderId);
     ...
     */
    @PostMapping("submit")
    public Object submit(@LoginUser Integer userId, @RequestBody CocoAftersale aftersale) {
        if (userId == null) {
            return ResponseUtil.unlogin();
        }
     ...
     */
    @PostMapping("cancel")
    public Object cancel(@LoginUser Integer userId, @RequestBody CocoAftersale aftersale) {
        if (userId == null) {
            return ResponseUtil.unlogin();
        }
        ...
        CocoAftersale aftersaleOne = aftersaleService.findById(userId, id);
    ...
    private Object validate(CocoAftersale aftersale) {
